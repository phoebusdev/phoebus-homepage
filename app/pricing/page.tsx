            ...
            <div className="max-w-6xl mx-auto w-full">
              <div className="hero-neumorphic-card text-center">
                ...
                <p className="text-lg sm:text-xl text-text-secondary max-w-4xl mx-auto mb-8">
                  No hidden costs, no scope creep, no surprises. What we quote is what you pay.
                </p>
              </div>
            </div>
          </section>
              ...
              <div className="transform scale-75 origin-center" style={{ overflow: 'visible' }}>
                <div className="relative">
                  ...
                  <div className="space-y-4 mb-8">
                    {/* Row 1: Transparent Pricing + No hidden fees */}
                    <div className="grid grid-cols-12 gap-4">
                      {/* Transparent Pricing - auto-sized to content */}
                    ...
                    {/* Row 2: Fixed Costs + No scope creep */}
                    <div className="grid grid-cols-12 gap-4">
                      {/* Fixed Costs - auto-sized to content */}
                      <div className="col-span-12 md:col-span-6">
                        ...
                        >
                          ...
                          >
                            <div className="hero-neumorphic-card-split">
                              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-display neumorphic-text-3d">
                                <span className="plastic-tube-text">Fixed Costs</span>
                              </h1>
                            </div>
                          </div>
                        </DualParallax>
                      </div>
                      {/* No scope creep - fills remainder */}
                      <div className="col-span-12 md:col-span-6">
                        <DualParallax
                        ...
                        >
                          ...
                          >
                            <div className="hero-neumorphic-card-split text-center h-full flex flex-col justify-center">
                              <Icon name="lock" className="text-4xl mb-3 text-sage-green" />
                              <p className="text-base text-text-secondary font-medium">No scope creep</p>
                            </div>
                          </div>
                        </DualParallax>
                      </div>
                    ...
                    {/* Row 3: High Value + Guaranteed */}
                    <div className="grid grid-cols-12 gap-4">
                      {/* High Value - auto-sized to content */}
                      <div className="col-span-12 md:col-span-8">
                        ...
                        >
                          ...
                          >
                            <div className="hero-neumorphic-card-split">
                              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-display neumorphic-text-3d">
                                <span className="plastic-tube-text">High Value</span>
                              </h1>
                            </div>
                          </div>
                        </DualParallax>
                      </div>
                      {/* Guaranteed - fills remainder */}
                      <div className="col-span-12 md:col-span-4">
                        ...
                        >
                          ...
                          >
                            <div className="hero-neumorphic-card-split text-center h-full flex flex-col justify-center">
                              <Icon name="verified" className="text-4xl mb-3 text-salmon-pink" />
                              <p className="text-base text-text-secondary font-medium">Guaranteed</p>
                            </div>
                          </div>
                        </DualParallax>
                      </div>
                          ...
                          >
                            <div className="hero-neumorphic-card-split text-center">
                              <p className="text-lg sm:text-xl md:text-2xl text-text-secondary max-w-4xl mx-auto">
                                <span className="matter-plastic-light">What we quote is what you pay</span>, delivered exactly when promised. No surprises, no additional costs.
                              </p>
                            </div>
                          </div>
                        </DualParallax>
